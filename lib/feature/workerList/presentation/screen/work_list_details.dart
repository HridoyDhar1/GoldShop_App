...
class WorkingDetailsScreen extends StatelessWidget {
          ...
          return pw.Padding(
            ...
            child: pw.Column(
              ...
              children: [
                ...
                pw.Text("Worker Name: $workerName", style: pw.TextStyle(fontSize: 18)),
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text("Worker Name: $workerName", style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
